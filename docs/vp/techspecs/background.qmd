...
For each decision, briefly state: “We chose X because…” 

Orchestration: Prefect → flexible Python tasks, strong retrying & scheduling 

Transformations: dbt → version-controlled SQL, built-in testing and documentation 

Analytical store: DuckDB → lightweight, embeddable OLAP engine for ad-hoc analytics 
